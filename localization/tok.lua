...
local loc_table = {
        ...
        Joker = {
            j_8_ball = {
                ...
                text = {
                    ...
                    "e {C:tarot}lipu nasa{}",
                    "{C:inactive}(tan poki moku li ken jo)"
                },
            },
            j_abstract = {
                name = "ijo jan",
            ...
            j_card_sharp = {
                ...
                text = {
                    ...
                    "{C:attention}luka{} ante utala ni la,",
                    "ni li pana e mute {X:mult,C:white} X#1# {}",
                },
            },
            j_cartomancer = {
            ...
            j_duo = {
                ...
                text = {
                    "luka pali li jo e {C:attention}#2#",
                    "la pana e mute {X:mult,C:white} X#1# "
                },
                unlock = {
                    "pini musi tan ni:",
            ...
            j_hallucination = {
                ...
                text = {
                    ...
                    "{C:green}#1# tan #2#{} la",
                    "ni li pali e {C:tarot}lipu nasa",
                    "{C:inactive}(tan poki moku li ken jo)"
                },
            },
            j_hanging_chad = {
            ...
            j_idol = {
                name = "ijo wawa",
                text = {
                    "lipu pi {C:attention}#2#{} tan {V:1}#3#",
            ...
            j_matador = {
                ...
                text = {
                    "pali luka pi pali e {C:attention}utala wawa{} la,",
                    "ni li pana e mani {C:money}$#1#{}",
            ...
            j_riff_raff = {
                ...
                text = {
                    ...
                    "mute {C:attention}#1#{}",
                    "{C:inactive}(tan poki ona li ken jo)"
                },
            },
            j_ring_master = {
                ...
                unlock = {
                    "o lukin e kulupu utala {C:attention}#1#"
                },
            },
            j_rocket = {
        ...
        Other = {
            ...
            blue_seal = {
                ...
                text = {
                    ...
                    "pali e {C:planet}lipu mun{} pi {C:attention}luka pini{}",
                    "{C:inactive}(tan poki ona li ken jo)"
                },
            },
            blue_sticker = {
    ...
    misc = {
        achievement_descriptions = {
            ...
            ante_up = "o lukin e utala nanpa 4",
            ante_upper = "o lukin e utala nanpa 8",
        ...
        dictionary = {
            ...
            ph_mr_bones = "jan moli la sina li moli ala",
